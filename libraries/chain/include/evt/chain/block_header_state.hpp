...
FC_REFLECT(evt::chain::detail::block_header_state_common,
           (block_num)(dpos_proposed_irreversible_blocknum)(dpos_irreversible_blocknum)
           (active_schedule)(blockroot_merkle)(producer_to_last_produced)
           (producer_to_last_implied_irb)(block_signing_key)(confirm_count));

FC_REFLECT(evt::chain::detail::schedule_info,
           (schedule_lib_num)(schedule_hash)(schedule));

FC_REFLECT_DERIVED(evt::chain::block_header_state, (evt::chain::detail::block_header_state_common),
